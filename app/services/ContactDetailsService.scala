...
class ContactDetailsServiceImpl @Inject()(val corporationTaxRegistrationRepository: CorporationTaxRegistrationMongoRepository) extends ContactDetailsService
